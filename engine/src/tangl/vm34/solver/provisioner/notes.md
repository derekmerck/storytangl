...
- **Dependency**: An edge from a "needer" node that requires something, to a "needed" node that satisfies the requirement.
- **Affordance**: The inverse edge of a dependency, from the needed node back to the needer.
