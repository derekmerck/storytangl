...
> Current contract: use `tangl.journal.fragments` for fragment models, `tangl.presentation` for advisory values, `docs/src/design/story/JOURNAL_COMPOSE_CONTRACT.md` for post-merge composition, and `tangl.service.response` for service-native runtime payloads.
