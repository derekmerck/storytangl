...
class StagingHints(BaseModel, extra="allow"):
    """
    Media StagingHints are similar to content :class:`PresentationHint` annotations --
    they provide client-side suggestions for media staging, position, arrival, and
