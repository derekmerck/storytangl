...
from tangl.core.handlers import TaskPipeline
...
on_gather_templates = TaskPipeline[Entity, list[StringMap]]("on_gather_templates")
...
class HasTemplatedDefaults(Entity):
    """
    ...
    @classmethod
    def _provide_cls_templates(cls, **context) -> list[TemplatesMap]:
        return [ cls.cls_template_map ]
