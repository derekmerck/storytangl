...
on_can_associate = HandlerPipeline[Node, bool]("on_can_associate", strategy=PipelineStrategy.ALL)
on_can_disassociate = HandlerPipeline[Node, bool]("on_can_disassociate", strategy=PipelineStrategy.ALL)
