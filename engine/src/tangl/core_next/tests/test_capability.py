...
from tangl.core_next.provision.capability import (
    ContextCap,
    ProvisionCap,
    RedirectCap,
)
from tangl.core_next.enums import StepPhase, Tier
from tangl.core_next.provision import Requirement
...
def test_provisioncap_apply_and_provides():
    cap = ProvisionCap(provides={"shop"}, tier=Tier.GRAPH)
