...
from tangl.compilers import BaseScriptItem
# from tangl.media import MediaItemScript
from .structure.structure_script_models import SceneScript
from .concept.concept_script_models import ActorScript, PlaceScript, AssetsScript

logger = logging.getLogger(__name__)


class StoryScript(BaseScriptItem):
    ...
    places: list[PlaceScript] | dict[UniqueLabel, PlaceScript] = None  # a_dark_place: { name: ...
    ...
    @field_validator('scenes', 'actors', 'places', mode="before")
    @classmethod
