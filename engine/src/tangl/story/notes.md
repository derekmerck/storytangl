...
- **Episodic Process** -- flow control along structural nodes and edges, realizing and ordering events and concepts from the fabula into a stable configuration, and updating the syuzhet, the story as resolved by will
