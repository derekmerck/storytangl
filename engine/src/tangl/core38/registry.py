...
See Also
--------
- `tangl.core38.graph.Graph` for a topology-specialized registry.
- `tangl.core38.template.TemplateRegistry` for template ownership and lookup.
...
class Registry(Entity, Generic[ET]):
    ...
    See Also
    --------
    `tangl.core38.graph.Graph`, `tangl.core38.template.TemplateRegistry`
