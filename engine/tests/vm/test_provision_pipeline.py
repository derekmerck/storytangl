# engine/tests/vm/test_provision_pipeline.py
"""Contract tests for the vm provisioning/planning pipeline.

The planning system in vm is deliberately simpler than v3.7:
    ...
    def test_provision_handler_fires_during_follow_edge(
        ...
        with _cleanup_behaviors(record_provision, sh.validate_successor_exists):
            ...
            assert successor_contexts == [
                (b, b.uid, ResolutionPhase.PLANNING),
            ]
