"""Shared fixtures and helpers for vm tests.
...
def clean_vm_dispatch():
    ...
    Some non-vm modules (for example story runtime handlers) register vm hooks
    at import time during test collection. vm tests should run against a clean
