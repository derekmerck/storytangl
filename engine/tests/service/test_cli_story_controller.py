...
module_path = CLI_SRC / "tangl" / "cli" / "controllers" / "story_controller.py"
spec = importlib.util.spec_from_file_location("story_controller_cmdset", module_path)
assert spec and spec.loader
story_module = importlib.util.module_from_spec(spec)
spec.loader.exec_module(story_module)
StoryController = story_module.StoryController
