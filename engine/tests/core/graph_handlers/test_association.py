...
def test_basic_parent_child_association(node1, node2):
    ...
    node1.associate_with(other=node2, relationship="as_parent")
...
def test_peer_association(node1, node2):
    ...
    node1.associate_with(other=node2, relationship="as_peer")
...
def test_prevent_cycles(node1, node2):
    ...
    with pytest.raises(ValueError):
        node2.associate_with(other=node1, relationship="as_parent")
...
def test_invalid_relationship(node1, node2):
    ...
    with pytest.raises(ValueError):
        node1.associate_with(other=node2, relationship="invalid")
...
def test_disassociation(node1, node2):
    """Test disassociation"""
    node1.associate_with(other=node2, relationship="as_peer")
    node1.disassociate_from(other=node2)
...
def test_multiple_peer_associations(node1, node2):
    ...
    node1.associate_with(other=node2, relationship="as_peer")
    node1.associate_with(other=node3, relationship="as_peer")
