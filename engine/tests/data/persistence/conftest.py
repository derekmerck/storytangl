...
from tangl.data.persistence.serializers import *
from tangl.data.persistence.storage import *
from tangl.data.persistence.structuring import StructuringHandler
...
def manager(request, tmpdir):
    ...
    from tangl.data.persistence import PersistenceManager
