"""Fragment emission-order contracts for story journal handlers.
...
import tangl.story  # noqa: F401 – registers story handlers into story_dispatch
...
class TestDoJournalDispatchOrder:
    """Story handlers registered in story_dispatch maintain order under dispatch."""
