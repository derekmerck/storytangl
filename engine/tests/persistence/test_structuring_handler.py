...
def test_unstructure_emits_kind_and_obj_cls() -> None:
    ...
    assert payload["obj_cls"] is StructuringModel
...
def test_structure_accepts_legacy_obj_cls_alias() -> None:
    uid = uuid4()
    payload = {"obj_cls": StructuringModel, "uid": uid, "label": "demo"}
