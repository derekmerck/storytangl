...
from .renderable import Renderable, on_render
from .runtime import HasEffects, on_apply_effects

on_enter = TaskPipeline['TraversableNode', Optional[Edge]](label="on_enter", pipeline_strategy=PipelineStrategy.FIRST)

on_exit = TaskPipeline['TraversableNode', Any](label="on_exit", pipeline_strategy=PipelineStrategy.GATHER)


class TraversableNode(HasContext, Node):
    """
