// v15-fixtures-core.js — core fixtures (vocab Tier S/P1/P2) for v1.5 demo.
//
// Every fixture is a single { envelope, projected_state } pair shaped against
// STORYTANGL_WIDGET_VOCAB v1.5, with sandbox info-channel and CarWars extension
...
window.V15_FIXTURES_CORE = (function () {
  ...
  // ===========================================================================
  // 4) MANOR — sandbox scenario (Tier P2 + sandbox/info-channel conventions)
  ...
  const manor = (() => {
    ...
    return {
      envelope: {
        ...
        metadata: {
          world: "manor",
          // v1.5 sandbox info-channel — typed metadata.info_state
          info_affordances: [
      ...
      projected_state: {
        sections: [
          // ----- WORLD TIME (Tier S kv_list w/ kind:"world_time")
