...
The `World` class is a singleton that manages story templates, custom classes, assets, and resources.
...
**Returns**: StoryGraph ready for navigation

**Example**:
```python
story = world.create_story("player_1")
frame = story.cursor
```
